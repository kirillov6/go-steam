...
// receive an error EResult_AccountLogonDenied and Steam will send you an authcode.
// Then you have to login again, this time with the authcode.
...
func (a *Auth) handleLogOnResponse(packet *protocol.Packet) {
	...
	if result == steamlang.EResult_OK {
		...
		a.client.Web.webLoginKey = body.GetWebapiAuthenticateUserNonce()
